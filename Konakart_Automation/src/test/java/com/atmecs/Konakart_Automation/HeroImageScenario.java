...
public class HeroImageScenario extends BrowserInvoke {
	...
	@Test
	public void HeroImageValidation() throws IOException, InterruptedException {
		
		PageActions pageaction = new PageActions();
		PropertiesFileReader.loadProperty(FilePath.LOCATORS_FILE);
		ExtentReport.logger = ExtentReport.extent.startTest("HeroImageValidation");
	
		WebElement elem =driver.findElement(By.xpath(PropertiesFileReader.getData("loc.heroimage.image")));
		String xpathtext =elem.getText();
		
	
		driver.get("https://www.konakart.com/konakart/Electronics/Tablets/Amazon/Kindle-Fire-HD/DLBCO410/2_34.action");
